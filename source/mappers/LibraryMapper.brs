...
' LibraryMapper_Map
'-------------------------------------------------------------------------------
function LibraryMapper_Map(value as dynamic) as object
    mappedLibraries = []
    libraries = __LibraryMapper_ToArray(value)
...
'-------------------------------------------------------------------------------
' __LibraryMapper_ToArray
'-------------------------------------------------------------------------------
function __LibraryMapper_ToArray(value as dynamic) as dynamic
