...
- Substantial refactoring of player compontent. Grouped/organized the million local variables into logical/functional groupings. Also broken the player UI out into different components. Static/stateless helper functions broken out into helper modules.
